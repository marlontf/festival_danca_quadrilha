...
<table class="table table-striped table-hover table-bordered" style="background-color: white">
	<legend align='center'>Quesito Quadrilha (Infantil)</legend>
	<thead>
...
<?php if($tb == '2'): ?>
<table class="table table-striped table-hover table-bordered" style="background-color: white">
	<legend align='center'>Quesito Casamento (Infantil)</legend>
	<thead>
...
<?php if($tb == '3'): ?>
<table class="table table-striped table-hover table-bordered" style="background-color: white">
	<legend align='center'>Quesito Marcador (Infantil)</legend>
	<thead>
