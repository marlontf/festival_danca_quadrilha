...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
			<td><?=$count?>º</td>
			<td><?=utf8_encode($dado_adulto['nome']);?></td>
			<td><?=utf8_encode($dado_adulto['total']);?></td>
		</tr>
		<?php endforeach; ?>
	</tbody>
</table>
...
<?php $count =0; ?>
	<div class="row">
		<div class="col-md">
			<h4 align="center">Classificação Adulto (Quesito Quadrilha)</h4>
			<table class="table table-bordered table-hover">
				<thead>
					<tr class="btn-dark">
						<th>Classificação</th>
...
<?php $count =0; ?>
		<div class="col-md">
			<h4 align="center">Classificação Adulto (Quesito Casamento)</h4>
			<table class="table table-bordered table-hover">
				<thead>
					<tr class="btn-dark">
						<th>Classificação</th>
...
<?php $count =0; ?>
		<div class="col-md">
			<h4 align="center">Classificação Adulto (Quesito Marcador)</h4>
			<table class="table table-bordered table-hover">
				<thead>
					<tr class="btn-dark">
						<th>Classificação</th>
